...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery(function($){$(function(){$('.fl-node-602be2050c5f6 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){$(document).ready(function(){var os=new OnScreen();os.on('enter','.mpl-calendar-container',(element,event)=>{$(element).addClass('start');});});})(jQuery);(function($){$(document).ready(function(){var os=new OnScreen();os.on('enter','.mpl-booked-match-container',(element,event)=>{$(element).addClass('start');});});})(jQuery);(function($){$(document).ready(function(){var os=new OnScreen();os.on('enter','.mpl-chat-container',(element,event)=>{$(element).addClass('start');});});})(jQuery);jQuery(function($){$(function(){$('.fl-node-5f91a3a3ae8d5 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});