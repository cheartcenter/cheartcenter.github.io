...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){$(document).ready(function(){var os=new OnScreen();os.on('enter','.mpl-multi-purpose-headers',(element,event)=>{$(element).addClass('start');});});})(jQuery);(function($){$(document).ready(function(){var os=new OnScreen();os.on('enter','.mpl-chat-container',(element,event)=>{$(element).addClass('start');});});})(jQuery);jQuery(function($){$(function(){$('.fl-node-5fda3b2c8458f .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});