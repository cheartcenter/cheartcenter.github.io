...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery(function($){$(function(){$('.fl-node-5b1eefaf6083a .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){$('.fl-node-5bc896fadc7a0 .mpl-post-carousel').not('.slick-initialized').slick({slidesToScroll:1,accessibility:true,focusOnChange:false,arrows:false,draggable:true,swipe:true,pauseOnHover:true,mobileFirst:true,slidesToShow:3,infinite:true,autoplay:true,speed:15000,autoplaySpeed:1,cssEase:"linear",dots:false,responsive:[{breakpoint:479,settings:{slidesToShow:3}},{breakpoint:767,settings:{slidesToShow:5}},{breakpoint:959,settings:{slidesToShow:8}},]});$('.slick-disabled').parent().addClass('testimonial-end');$('.slick-arrow').click(function(){$('.slick-arrow:not(.slick-disabled)').attr('aria-hidden','false');$(this).parent().removeClass('testimonial-end');$('.slick-disabled').attr('aria-hidden','true').parent().addClass('testimonial-end');})
$('.fl-node-5bc896fadc7a0 .mpl-post-carousel').on('swipe',function(event,slick,direction){$(this).removeClass('testimonial-end');$('.slick-disabled').parent().addClass('testimonial-end');})})(jQuery);jQuery(function($){$(function(){$('.fl-node-5bb505ddb95f6 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});